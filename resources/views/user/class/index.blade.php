        ...
        <div class="card">
          <div class="card-body">
            <div class="row g-3 mb-3">
              @if ($majors->count() > 0)
                <div class="col-md"><label class="form-label">Jurusan</label><select class="form-select" id="major-filter"
              ...
              @endif
              <div class="col-md"><label class="form-label">Tingkat</label><select class="form-select" id="level-filter"
                  aria-label="Select parent category">
        ...
        <div class="card">
          <div class="card-header card-no-border text-end">
            <div class="card-header-right-icon">
              <a class="btn btn-primary f-w-500 mb-2" data-bs-toggle="modal" data-bs-target="#addClassModal"><i
                        ...
                        <div class="p-20">
                          <form class="row g-3 needs-validation" novalidate="" id="addClassForm">
                            <div class="col-md-6">
                              ...
                              <input class="form-control" id="className" type="text" placeholder="Masukan nama kelas"
                                name="name">
