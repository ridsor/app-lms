                ...
                <div class="card-body">
                  <div class="course-widget">
                    <div class="course-icon">
                      <img style="width:24px; height:24px; filter: invert(1);" src="{{ asset('assets/icons/task.png') }}" />
                    </div>
                    <div>
                      <h4 class="mb-0"> <span class="counter" data-target="100">{{ $countTasks }}</span>
                      </h4><span class="f-light">Belum Dikerjakan</span><a href="{{ route('user.task.index') }}"
                ...
                <div class="card-body">
                  <div class="course-widget">
                    <div class="course-icon warning">
                      <img style="width:24px; height:24px; filter: invert(1);" src="{{ asset('assets/icons/exam.png') }}" />
                    </div>
                    <div>
                      <h4 class="mb-0"> <span class="counter" data-target="100">{{ $countExams }}</span>
                      </h4><span class="f-light">Belum dikerjakan</span><a href="{{ route('user.exam.index') }}"
                        class="btn btn-light f-light">Lihat
              ...
              <div class="card widget-hover overflow-hidden">
                ...
                <div class="card-body pt-0 count-student">
                  <div class="school-wrapper">
                    ...
                    <div class="school-body"> <img src="{{ asset('assets/images/teacher.svg') }}" alt="total teachers">
                      <div class="right-line"><img src="{{ asset('assets/images/home-line.png') }}" alt="line"></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card widget-hover overflow-hidden">
                ...
                <div class="card-body pt-0 count-student">
                  <div class="school-wrapper">
                    ...
                    <div class="school-body"> <img src="{{ asset('assets/images/student.svg') }}" alt="total teachers">
                      <div class="right-line"><img src="{{ asset('assets/images/home-line.png') }}" alt="line"></div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="row g-2 align-items-center">
                    <div class="col-md-6">
                      <div class="light-card attendance-card widget-hover">
                        <div class="left-overview-content">
                          <div class="svg-box"><img src="{{ asset('assets/images/home-attendance.png') }}" alt="homework">
                          </div>
                        </div>
                    ...
                    <div class="col-md-6">
                      <div class="light-card attendance-card widget-hover">
                        <div class="left-overview-content">
                          <div class="svg-box"><img src="{{ asset('assets/images/home-attendance.png') }}"
                              alt="homework"></div>
                        </div>
                        <div class="right-overview-content">
                          <div>
                                ...
                                <div class="common-f-start gap-3">
                                  <div class="w-100">
                                    ...
                                    <div class="d-flex gap-2 flex-wrap">
                                      ...
                                      <div>
                                        <span class="text-nowrap">{{ $schedule->class->students_count }}
                                          Siswa</span>
                                      </div>
                                    </div>
                                      ...
                                      @foreach ($schedule->schedule_times as $schedule_time)
                                        ...
                                        <div class="d-flex gap-2">
                                          <div class="col d-flex align-items-center">
                                            <i data-feather="calendar" witdh="24"></i>
