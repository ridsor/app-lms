        ...
        <div class="card">
          <div class="card-header card-no-border text-end">
            <div class="card-header-right-icon">
              ...
              <div class="row g-3 justify-content-end" id="student-action-buttons">
                <div class="col-auto">
                ...
                <div class="col-auto">
                  <a id="bulk-edit-selected"
                    class="d-block rounded-2 d-flex justify-content-center align-items-center light-square bg-light-primary px-3 py-2"
                    style="cursor: pointer;">
                    <span class="me-1 text-dark" id="bulk-edit-selected-count">0</span>
                          ...
                          <form class="row g-3" id="bulkEditStudentForm">
                            <div class="col-12">
                                <label class="form-label" for="bulkEditStudentHomeroomTeacher">Wali
                                  Kelas</label>
                                <select class="selectpicker search-picker" data-live-search="true" id="bulkEditStudentHomeroomTeacher"
                                  name="homeroom_teacher_id">
                                  <option value="">Pilih Wali Kelas</option>
                                  @foreach ($teachers as $teacher)
                                    <option value="{{ $teacher->id }}">{{ $teacher->name }}</option>
