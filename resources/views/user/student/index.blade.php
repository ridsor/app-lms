                ...
                <div class="card rounded-responsive">
                    <div class="card-body common-offcanvas">
                        <div class="row g-2 align-items-center justify-content-end">
                            <div class="col-auto">
                                <button type="button" data-bs-toggle="offcanvas" data-bs-target="#parentAccount"
                                    aria-controls="parentAccount"
                                ...
                                <div class="offcanvas offcanvas-end" id="parentAccount" tabindex="-1"
                                    aria-labelledby="parentAccountLabel">
                                    <div class="offcanvas-header pb-0">
                                        <h5 class="offcanvas-title" id="parentAccountLabel">Akun Orang Tua</h5><button
                                    ...
                                    <div class="offcanvas-body custom-input custom-scrollbar">
                                        <form id="export-parent-account-form" method="GET"
                                            ...
                                            <div class="row g-3">
                                                @if ($majors->count() > 0)
                                                    <div class="col-12">
                                                        <label class="form-label"
                                                            for="export-parent-account-major-filter">Jurusan</label>
                                                        <select class="form-select"
                                                            @cannot('student.*') disabled @endcannot
                                                            id="export-parent-account-major-filter" name="major"
                                                ...
                                                <div class="col-12">
                                                    <label class="form-label"
                                                        for="export-parent-account-class-filter">Kelas</label>
                                                    <select class="form-select" @cannot('student.*') disabled @endcannot
                                                        id="export-parent-account-class-filter" name="class"
                                                ...
                                                <div class="col-12">
                                                    <label class="form-label"
                                                        for="export-parent-account-level-filter">Tingkat</label>
                                                    <select class="form-select" id="export-parent-account-level-filter"
                                                        name="level" aria-label="Select level">
                            ...
                            <div class="col-auto">
                                ...
                                <div class="offcanvas offcanvas-end" id="studentAccount" tabindex="-1"
                                    ...
                                    <div class="offcanvas-header pb-0">
                                        <h5 class="offcanvas-title" id="studentAccountLabel">Akun Siswa</h5><button
                                            class="btn-close" type="button" data-bs-dismiss="offcanvas"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="offcanvas-body custom-input custom-scrollbar">
                                        <form id="export-student-account-form" method="GET"
                                            ...
                                            <div class="row g-3">
                                                @if ($majors->count() > 0)
                                                    <div class="col-12">
                                                        <label class="form-label"
                                                            for="export-student-account-major-filter">Jurusan</label>
                                                        <select class="form-select"
                                                            @cannot('student.*') disabled @endcannot
                                                            id="export-student-account-major-filter" name="major"
                                                            aria-label="Select major">
                                                            <option value="" selected>Pilih Jurusan</option>
                                                            @foreach ($majors as $major)
                                                                <option value="{{ $major->name }}">{{ $major->name }}
                                                ...
                                                <div class="col-12">
                                                    <label class="form-label"
                                                        for="export-student-account-class-filter">Kelas</label>
                                                    <select class="form-select" @cannot('student.*') disabled @endcannot
                                                        id="export-student-account-class-filter" name="class"
                                                        aria-label="Select class">
                                                        <option value="" selected>Pilih Kelas</option>
                                                        @foreach ($classNames as $class)
                                                            <option value="{{ $class->name }}">{{ $class->name }}
                                                ...
                                                <div class="col-12">
                                                    <label class="form-label"
                                                        for="export-student-account-level-filter">Tingkat</label>
                                                    <select class="form-select" id="export-student-account-level-filter"
                                                        name="level" aria-label="Select level">
                                                        <option value="" selected>Pilih Tingkat</option>
                                                        @foreach ($classLevels as $classLevel)
                                                            <option value="{{ $classLevel->level }}">
                            ...
                            <div class="col-auto">
                                ...
                                <div class="offcanvas offcanvas-end" id="filter" tabindex="-1"
                                    ...
                                    <div class="offcanvas-header pb-0">
                                        <h5 class="offcanvas-title" id="filterLabel">Filter</h5><button class="btn-close"
                                    ...
                                    <div class="offcanvas-body custom-input custom-scrollbar">
                                        <div class="row g-3">
                                            @if ($majors->count() > 0)
                                                <div class="col-12">
                                                    ...
                                                    <select class="form-select" id="major-filter"
                                                        aria-label="Select major" @cannot('student.*') disabled @endcannot>
                                                        <option value="" selected>Pilih Jurusan</option>
                                                        @foreach ($majors as $major)
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select class="form-select" @cannot('student.*') disabled @endcannot
                                                    id="class-filter" aria-label="Select class">
                                                    <option value="" selected>Pilih Kelas</option>
                                                    @foreach ($classNames as $class)
                                                        <option value="{{ $class->name }}">{{ $class->name }}
                                                        </option>
