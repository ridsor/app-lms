      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body pt-0">
            <form id="export-form" method="GET" action="{{ route('user.student.export') }}">
              <div class="row g-3">
                @if ($majors->count() > 0)
                  <div class="col-md">
                    <label class="form-label" for="export-major-filter">Jurusan</label>
                    <select class="form-select" id="export-major-filter" name="major" aria-label="Select major">
                ...
                @endif
                <div class="col-md">
                  <label class="form-label" for="export-class-filter">Kelas</label>
                  <select class="form-select" id="export-class-filter" name="class" aria-label="Select class">
                ...
                <div class="col-md">
                  <label class="form-label" for="export-level-filter">Tingkat</label>
                  <select class="form-select" id="export-level-filter" name="level" aria-label="Select level">
                ...
                <div class="col-auto d-flex justify-content-start align-items-end">
                  <button type="submit" class="btn btn-success f-w-500 w-100" id="student-account-btn">
        ...
        <div class="card">
          <div class="card-header card-no-border text-end">
            <div class="card-header-right-icon">
              <a class="btn btn-primary f-w-500 mb-2" data-bs-toggle="modal" data-bs-target="#addStudentModal"><i
                          ...
                          <form class="row g-3 needs-validation" novalidate="" id="addStudentForm">
                            ...
                            <div class="col-lg-6">
                              ...
                              <select class="selectpicker search-picker" data-live-search="true"
                                id="studentHomeroomTeacher" name="homeroom_teacher_id">
                        ...
                        <div class="p-20">
                          <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                              ...
                              <div class="form-control-plaintext" id="viewStudentHomeroomTeacher"></div>
                            </div>
                            <div class="col-lg-6">
                      ...
                      <div class="text-start">
                        <div class="p-20">
                          ...
                          <form class="row g-3" id="bulkEditStudentForm">
                            ...
                            <div class="col-12">
                              <label class="form-label" for="bulkEditStudentHomeroomTeacher">Wali
                                Kelas</label>
                              <select class="selectpicker search-picker" data-live-search="true"
