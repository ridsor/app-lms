        ...
        <div class="card">
          <div class="card-body">
            <div class="row g-3 mb-3">
              ...
              <div class="col-md"><label class="form-label">Dari</label><input class="form-control datepicker-here"
                  autocomplete="off" id="start-date-filter" type="text" placeholder="dd/mm/yyyy" data-language="id">
              </div>
              <div class="col-md"><label class="form-label">Sampai</label><input class="form-control datepicker-here"
                  autocomplete="off" id="end-date-filter" type="text" placeholder="dd/mm/yyyy" data-language="id">
              </div>
              <div class="col  d-flex justify-content-start align-items-end"><a class="btn btn-primary f-w-500 w-100"
                  id="filter-btn">Terapkan</a></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          <div class="card-header card-no-border text-end">
            <div class="card-header-right-icon">
                      ...
                      <div class="text-start">
                        <div class="p-20">
                          <form class="row g-3 needs-validation" novalidate id="addPeriodForm">
                            ...
                            <div class="col-md-6">
                              <label class="form-label" for="semester">Semester<span class="txt-danger">*</span></label>
                              <select class="form-select" id="addSemester" name="semester" required>
                                <option value="" selected>Pilih Semester</option>
                                <option value="odd">Ganjil</option>
                                <option value="even">Genap</option>
                              </select>
                            ...
                            <div class="col-md-6">
                              ...
                              <input class="form-control" id="addAcademicYear" type="text"
                                placeholder="Contoh: 2024/2025" name="academic_year">
                              <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                              ...
                              <input class="form-control datepicker-here-minmax" autocomplete="off" id="addStartDate"
                                type="text" placeholder="dd/mm/yyyy" name="start_date" data-language="id">
                              <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                              ...
                              <input class="form-control datepicker-here-minmax" autocomplete="off" id="addEndDate"
                                type="text" placeholder="dd/mm/yyyy" name="end_date" data-language="id">
                              <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-12 d-flex justify-content-end">
                              <button class="btn btn-primary" type="submit" id="addPeriodSubmitBtn">Tambah +</button>
                            </div>
                          </form>
                        </div>
                      </div>
              ...
              <div class="modal fade" id="editPeriodModal" tabindex="-1" aria-labelledby="editPeriodModal"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                  <div class="modal-content category-popup">
                    <div class="modal-header">
                        ...
                        <div class="p-20">
                          <form class="row g-3 needs-validation" novalidate id="editPeriodForm">
                            ...
                            <div class="col-md-6">
                              <label class="form-label" for="academicYear">Tahun
                                Akademik<span class="txt-danger">*</span></label>
                              <input class="form-control" id="editAcademicYear" type="text"
                                placeholder="Contoh: 2024/2025" name="academic_year">
                              <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12 d-flex justify-content-end">
                              <button class="btn btn-primary" type="submit" id="editPeriodSubmitBtn">Simpan</button>
                            </div>
                          </form>
                        </div>
                      </div>
