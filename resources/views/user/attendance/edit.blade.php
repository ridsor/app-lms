                                    ...
                                    <div class="col-12 col-md-6 col-lg-4">
                                        ...
                                        <p class="c-o-light f-w-600">
                                            <span id="total_attendance">{{ $meeting->attendances_count }}</span> dari <span
                                                id="total_user">{{ $meeting->schedule->class->students_count }}</span>
                                            Peserta
                                        </p>
                                    </div>
                                </div>
                          ...
                          object-fit: cover;"
                                    ...
                                    <div class="d-flex">
                                        <p class="mb-0 c-o-light fw-medium" id="teacher">
                                            {{ $meeting->schedule->teacher->name }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row justify-content-between align-items-center mb-4 px-4 g-2">
                                @can('attendance.edit')
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <button class="btn btn-outline-primary" id="cancel_change_attendance"
                                            style="display:none">
                                            Batal
                                        </button>
                                    ...
                                    <table class="table table-bordered" id="attendance-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2" class="update-column"> <span
                                                        class="c-o-light f-w-600">Update</span></th>
