                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <div class="c-o-light f-w-600">
                            <div class="d-flex gap-2">
                              ...
                              <div>&middot;</div>
                              <span>
                                <span id="start_time">00:00</span> - <span id="end_time">00:00</span> WIT
                              </span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-12 mt-4">
                          ...
                          <div class="row g-2">
                            ...
                            <div class="col-12 col-md-6">
                              ...
                              <p class="c-o-light f-w-600">
                                <span id="total_attendance">-</span> dari <span id="total_user">-</span> Peserta
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <table class="table table-bordered" id="attendance-table">
                  <thead>
                    <tr>
                      ...
                      @if (count($schedule->grouping_meetings->toArray()) > 0)
                        <th class="text-center" colspan="{{ count($schedule->grouping_meetings->toArray()) }}"> <span
                            class="c-o-light f-w-600">Pertemuan</span></th>
                      @endif
                      <th colspan="4" class="text-center"> <span class="c-o-light f-w-600">Jumlah</span></th>
                    </tr>
                    <tr>
