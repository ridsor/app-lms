                ...
                <div class="d-flex justify-content-end flex-grow-1 align-items-center gap-2">
                  @can('material.*')
                    <button
                      ...
                      style="width: 38px; height: 38px;" onclick="handleEditTask(event, {{ $task->id }})">
                    ...
                    <div class="col-12">
                      ...
                      <div class="c-o-light f-w-600">
                        <div class="form-check form-switch" style="pointer-events: none">
                          <input class="form-check-input" disabled {{ $task->allow_late_submission ? 'checked' : '' }}
                          ...
                          <div class="row g-3">
                            ...
                            <div class="col-12">
                              <div class="d-flex flex-column flatpicker-form">
                                <label class="form-label" for="startDate">Waktu Mulai<span
                                    class="txt-danger">*</span></label>
                                <input class="form-control flatpicker" id="editTaskStartTime" type="date"
                            ...
                            <div class="col-12">
                              <div class="d-flex flex-column flatpicker-form">
                                ...
                                <input class="form-control flatpicker" autocomplete="off" id="editTaskEndTime"
                                  type="date" placeholder="Pilih waktu selesai" name="end_time" data-language="id">
                                <div class="invalid-feedback"></div>
                              </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12 lateSubmission" style="display: none;">
                              <div class="d-flex flex-column flatpicker-form">
                                <label class="form-label" for="endDate">Batas Waktu
                                  Terlambat</label>
                                <input class="form-control flatpicker" autocomplete="off" id="editLateSubmissionTime"
                                  type="date" placeholder="Pilih batas waktu terlambat" name="late_submission_time"
                                  data-language="id">
                                <div class="invalid-feedback"></div>
                              </div>
                            </div>
                          ...
                          <div class="row g-3">
                              ...
                              <div class="taskFile">
                                ...
                                <div class="custom-file-upload w-100 border rounded-2 px-3 py-3">
                                  <label for="editTaskFile" class="d-flex align-items-center mb-0 w-100"
                                    ...
                                    <span style="color:#b0b0b0; font-weight:500;">Unggah
                                      File</span>
                                  </label>
                                </div>
                            ...
                            <div class="col-12">
                              ...
                              <div class="toolbar-box">
                                ...
                                <input type="hidden" id="editTaskDescription" name="description" class="quill">
                              </div>
                              <div class="invalid-feedback"></div>
                            </div>
                          </div>
