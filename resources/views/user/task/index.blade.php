            ...
            <div class="col-12 p-0">
                <div class="card h-100 my-0 rounded-responsive">
                    <form method="GET" action="">
                        <div class="card-body px-2 px-md-3 py-4 common-offcanvas">
                                        ...
                                        <div class="task-item border rounded-1 w-100 p-3">
                                            <div class="row g-2">
                                                <div class="col-12 col-md">
                                                    ...
                                                    <p class="mb-1">{{ $task->meeting->schedule->subject->code }}
                                                        {{ strtoupper($task->meeting->schedule->subject->name) }} &middot;
                                                        {{ $task->meeting->schedule->class->name }}{{ $task->meeting->schedule->class->level }}{{ $task->meeting->schedule->class->major ? ' ' . $task->meeting->schedule->class->major->name : '' }}
                                                        &middot; {{ Helper::getTaskTypeLabel($task->type) }}</p>
                                                    <p class="mb-2">
                                                        <span class="badge m-0 badge-light-primary px-2 py-1">Pertemuan
                                                            {{ $task->meeting->meeting_at }}</span>
                                                    </p>
                                                ...
                                                <div
                                                    class="col-12 justify-content-end col-md-auto d-flex align-items-center gap-2">
                                                    @role('teacher')
                                                        @if ($task?->not_yet_rated)
                                                            <span
                                                                class="badge m-0 badge-light-danger px-2 py-1 d-flex align-items-center">Belum
                                                                dinilai <span
                                                                    class="badge ms-1 badge-danger">{{ $task->not_yet_rated }}</span></span>
                                                        @endif
                                                    @endrole
                                                    @role(['student', 'parent'])
                                                        @if ($task?->submissions->where('task_id', $task->id)->isEmpty())
                                                            <span
                                                    ...
                                                    <a @role(['student', 'parent'])
                                                        href="{{ route('user.tasksubmission.show', $task->id) }}"
                                                        @endrole
                                                        @role(['teacher'])
                                ...
                                @else
                                    ...
                                    <div class="d-flex justify-content-center mb-3 w-100">
                                        <div class="px-4 py-5 d-grid" style="justify-items: center">
                                            ...
                                            <p class="mb-0 text-center">Belum ada tugas yang tersedia.</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
...
@section('scripts')
    ...
    <script>
        const default_end_date =
            "{{ request()->query('rentang-waktu-sampai') }}"
        const default_start_date =
            "{{ request()->query('rentang-waktu-dari') }}"
