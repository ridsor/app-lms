              ...
              <div class="row justify-content-between gap-2">
                ...
                <div class="d-flex flex-wrap align-items-center gap-2 col-12 justify-content-between col-md-auto">
                  <div class="d-flex gap-2 align-items-center h-100">
                    ...
                    <div class="form-check form-switch form-check-inline m-0"><input class="form-check-input check-size"
                        id="displayedValue" type="checkbox" data-id="{{ $task->id }}"
                        style="transform:translateY(2px)" role="switch" {{ $task->value_displayed ? 'checked' : '' }}>
                    </div>
                  </div>
                  <form action="{{ route('user.task.result.export', ['id' => $task->id]) }}" method="GET"
