                    ...
                    <div style="font-size: .8rem;" class="text-secondary">
                      @if ($task->is_late_submission_allowed_with_time)
                        <div class="d-flex align-items-center gap-2 mb-2">
                          <span class="icon"><i data-feather="clock" style="width:18px; height: 18px"></i></span>
                      ...
                      <div class="row g-0 g-sm-2">
                        <div class="col-12 col-md-auto d-flex align-items-center gap-2 justify-content-center">
                          <div class="d-flex align-items-center">
                            ...
                            <span class="mb-0 ms-2">{{ $task->start_time->translatedFormat('d M Y') }}</span>
                          </div>
                          <div>&middot;</div>
                          <span>
                        ...
                        <div class="col-12 col-md-auto d-flex align-items-center gap-2 justify-content-center">
                          <div class="d-flex align-items-center">
                            <span class="icon"><i data-feather="calendar" style="width:18px; height: 18px"></i></span>
                            <span class="mb-0 ms-2">{{ $task->end_time->translatedFormat('d M Y') }}</span>
                          </div>
                          <div>&middot;</div>
                          <span>
              ...
              <div class="py-3">
                ...
                @if ($task->file_path)
                  <div class="mb-3 view_file_path">
                    <div class="File py-3 px-3 mx-2 rounded-2 d-flex align-items-center flex-column gap-1">
            ...
            <div class="position-relative overflow-y-auto overflow-x-hidden" id="my-sticky">
              <div class="p-3">
                ...
                @can('task_submission.edit')
                  ...
                  <button class="btn btn-primary w-100 mb-3" id="submit-task" disabled data-id="{{ $task->id }}">
                    Simpan
                  </button>
                @endcan
              ...
              <div class="text-start">
                ...
                <form class="row g-3" method="POST" id="task-submission-content-link">
                  <div class="col-12">
                    ...
                    <input class="form-control" id="addLink" type="text" placeholder="" autocomplete="off"
                      name="link">
