    ...
    <div class="row g-2">
                ...
                @if ($question->question_file)
                    <div class="question-file mb-2">
                        @switch(Helper::getFileType($question->question_file))
                            @case('image')
                                <div class="image">
                                    <a href="{{ route('user.question.file.get', ['id' => $question->id]) }}" class="glightbox"
                                        data-gallery="question-{{ $question->id }}" data-type="image">
                                        <img src="{{ route('user.question.file.get', ['id' => $question->id]) }}"
                                            alt="soal gambar"
                                ...
                                <div class="audio">
                                    <audio controls>
                                        @if (strtolower(pathinfo($question_file, PATHINFO_EXTENSION)) == 'mp3')
                                            <source src="{{ route('user.question.file.get', ['id' => $question->id]) }}"
                                                type="audio/mpeg">
                                        @endif
                            ...
                            @case('archive')
                                <div class="archive">
                                    <div class="rounded-2 d-flex align-items-center gap-3">
                                        <div
                                            style="display:flex;align-items:center;justify-content:center;min-width:24px;min-height:24px;">
                                            <i class="fa fa-file text-primary fs-3"></i>
                                        </div>
                                        <div class="fw-medium text-break">
                                            File Arsip
                                        </div>
                                        <a href="{{ route('user.question.file.download', ['id' => $question->id]) }}"
                ...
                <div class="question-options">
                    ...
                    <div class="option-list d-flex flex-column gap-2">
                        <div class="option-item checkbox-checked">
                            <div class="d-flex align-items-center gap-2">
                                <label class="d-flex align-items-center mb-0" style="align-self: flex-start">
                                    <input type="radio" @if ($question->correct_answer == 'a') checked @endif
                                         value="a" disabled class="me-2 form-check-input"
                                    ...
                                    @if ($question->option_a_image)
                                        <div class="option-image mt-1">
                                            <a href="{{ route('user.question.option.file.get', ['id' => $question->id, 'option' => 'a']) }}"
                                                ...
                                                data-gallery="option-{{ $question->id }}-a">
                                                <img src="{{ route('user.question.option.file.get', ['id' => $question->id, 'option' => 'a']) }}"
                                                    alt="opsi gambar"
                                                    style="max-width:150px; max-height:150px; object-fit:cover; object-position:center;" />
                                            </a>
                                        </div>
                        ...
                        <div class="option-item checkbox-checked">
                            <div class="d-flex align-items-center gap-2">
                                <label class="d-flex align-items-center mb-0" style="align-self: flex-start">
                                    <input type="radio" @if ($question->correct_answer == 'b') checked @endif
                                         value="b" disabled class="me-2 form-check-input"
                                        style="transform: translateY(-2px)">
                                    ...
                                    @if ($question->option_b_image)
                                        <div class="option-image mt-1">
                                            <a href="{{ route('user.question.option.file.get', ['id' => $question->id, 'option' => 'b']) }}"
                                                class="glightbox" data-type="image"
                                                data-gallery="option-{{ $question->id }}-b">
                                                <img src="{{ route('user.question.option.file.get', ['id' => $question->id, 'option' => 'b']) }}"
                                                    alt="opsi gambar"
                                                    style="max-width:150px; max-height:150px; object-fit:cover; object-position:center;" />
                                            </a>
                                        </div>
                        ...
                        <div class="option-item checkbox-checked">
                            <div class="d-flex align-items-center gap-2">
                                <label class="d-flex align-items-center mb-0" style="align-self: flex-start">
                                    <input type="radio" @if ($question->correct_answer == 'c') checked @endif
                                         value="c" disabled class="me-2 form-check-input"
                                        style="transform: translateY(-2px)">
                                    ...
                                    @if ($question->option_c_image)
                                        <div class="option-image mt-1">
                                            <a href="{{ route('user.question.option.file.get', ['id' => $question->id, 'option' => 'c']) }}"
                                                class="glightbox" data-type="image"
                                                data-gallery="option-{{ $question->id }}-c">
                                                <img src="{{ route('user.question.option.file.get', ['id' => $question->id, 'option' => 'c']) }}"
                                                    alt="opsi gambar"
                                                    style="max-width:150px; max-height:150px; object-fit:cover; object-position:center;" />
                                            </a>
                                        </div>
                        ...
                        @if ($question->option_d)
                            <div class="option-item checkbox-checked">
                                <div class="d-flex align-items-center gap-2">
                                    <label class="d-flex align-items-center mb-0" style="align-self: flex-start">
                                        <input type="radio" @if ($question->correct_answer == 'd') checked @endif
                                             value="d" disabled
                                        ...
                                        @if ($question->option_d_image)
                                            <div class="option-image mt-1">
                                                <a href="{{ route('user.question.option.file.get', ['id' => $question->id, 'option' => 'd']) }}"
                                                    class="glightbox" data-type="image"
                                                    data-gallery="option-{{ $question->id }}-d">
                                                    <img src="{{ route('user.question.option.file.get', ['id' => $question->id, 'option' => 'd']) }}"
                                                        alt="opsi gambar"
                                                        style="max-width:150px; max-height:150px; object-fit:cover; object-position:center;" />
                                                </a>
                                            </div>
                        ...
                        @if ($question->option_e)
                            <div class="option-item checkbox-checked">
                                <div class="d-flex align-items-center gap-2">
                                    <label class="d-flex align-items-center mb-0" style="align-self: flex-start">
                                        <input type="radio" @if ($question->correct_answer == 'e') checked @endif
                                             value="e" disabled
                                            class="me-2 form-check-input" style="transform: translateY(-2px)">
                                        ...
                                        @if ($question->option_e_image)
                                            <div class="option-image mt-1">
                                                <a href="{{ route('user.question.option.file.get', ['id' => $question->id, 'option' => 'e']) }}"
                                                    class="glightbox" data-type="image"
                                                    data-gallery="option-{{ $question->id }}-e">
                                                    <img src="{{ route('user.question.option.file.get', ['id' => $question->id, 'option' => 'e']) }}"
                                                        alt="opsi gambar"
                                                        style="max-width:150px; max-height:150px; object-fit:cover; object-position:center;" />
                                                </a>
                                            </div>
        ...
        <div class="d-flex justify-content-end col-12 order-1 order-md-3 col-md-auto">
            <div class="d-flex gap-2 align-items-center">
                <div class="bg-white">
                    <button onclick="handleEditQuestion(event, {{ $question->id }})"
                ...
                <div class="bg-white">
                    <button onclick="handleDeleteQuestion(event, {{ $question->id }})"
                        style="width: 38px; height: 38px;"
