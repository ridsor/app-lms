              ...
              @case('image')
                <div class="image">
                  <a href="{{ route('user.question.file.get', ['id' => $question->id]) }}" class="glightbox"
                    ...
                    <img src="{{ route('user.question.file.get', ['id' => $question->id]) }}" alt="soal gambar"
                ...
                <div class="audio">
                  <audio controls>
                    @if (strtolower(pathinfo($question_file, PATHINFO_EXTENSION)) == 'mp3')
                      <source src="{{ route('user.question.file.get', ['id' => $question->id]) }}" type="audio/mpeg">
                    @endif
              ...
              @case('video')
                <div class="video">
                  <video width="320" height="240" controls>
                    <source src="{{ route('user.question.file.get', ['id' => $question->id]) }}" type="video/mp4">
    ...
    @can(['exam.edit', 'exam.delete'])
      <div class="d-flex justify-content-end col-12 order-1 order-md-3 col-md-auto">
        <div class="d-flex gap-2 align-items-center">
          ...
          <div class="bg-white">
            <button onclick="handleDeleteQuestion(event, {{ $question->id }})" style="width: 38px; height: 38px;"
