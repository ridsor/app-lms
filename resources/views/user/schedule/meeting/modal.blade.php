          ...
          <div class="p-20">
                ...
                <div class="d-flex flex-column gap-1">
                  <div class="d-flex gap-2 c-o-light f-w-600 flex-wrap text-nowrap">
                    <div class="d-flex align-items-center">
                      ...
                      <span class="mb-0 ms-2" id="date">{{ Helper::getDayName($schedule_time->day) }},
                      </span>
                    </div>
                    <div>
                      <span>
                        ...
                        -
                        <span id="end_time">{{ $meeting->schedule_time->end_time->translatedFormat('H:i') }}</span>
                        WIT
                      </span>
                    </div>
                  </div>
            ...
            <form class="row g-3 needs-validation" method="POST" novalidate="" id="editMeetingForm"
              ...
              <div class="col-12">
                ...
                <input class="form-control" id="meetingTitle" type="text" placeholder="Masukan judul pertemuan"
              ...
              <div class="col-lg-6">
                <label class="form-label" for="meetingMethod">Metode Pelajaran<span class="txt-danger">*</span></label>
                <select class="form-select" id="meetingMethod" name="meeting_method">
                  @foreach ($meetingMethods as $item)
                    <option value="{{ $item['value'] }}" @if ($item['value'] == $meeting->type) checked @endif>
                      {{ $item['label'] }}</option>
                  @endforeach
                </select>
                <div class="invalid-feedback"></div>
              ...
              <div class="col-lg-6">
                <label class="form-label" for="meetingType">Jenis<span class="txt-danger">*</span></label>
      ...
      <div class="modal-body p-0 custom-input">
        <div class="text-start">
          <div class="p-20">
            <div class="row g-2 mb-4">
              ...
              <div class="col-12 col-md-6 col-lg-6">
                ...
                <div class="d-flex flex-column gap-1">
                  <div class="c-o-light f-w-600 text-nowrap">
                    <span>
                      <span id="start_time">{{ $meeting->started_at?->translatedFormat('H:i') }}</span>
                      -
                      <span id="end_time">{{ $meeting->schedule_time->end_time->translatedFormat('H:i') }}</span>
                      WIT
                    </span>
              ...
              <div class="col-12">
                <div class="row justify-content-between align-items-center g-2">
                  ...
                  <div class="col-auto">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#fillAttendanceModal">
                      Isi Kehadiran
                    </button>
                  </div>
                </div>
            ...
            <form class="row g-3 needs-validation" method="POST" novalidate="" id="fillRealizationForm"
              data-id='{{ $meeting->id }}'>
              <div class="col-12">
                <label class="form-label" for="subjectMatter">Pokok Pembahasan</label>
                <input class="form-control" id="subjectMatter" type="text" placeholder="Masukan pokok pembahasan"
                  value="{{ $meeting->teaching_journal?->subject_matter }}" name="subject_matter">
                <div class="invalid-feedback">
                </div>
              </div>
              <div class="col-12">
                <label class="form-label" for="subSubjectMatter">Sub Pokok Pembahasan</label>
                <div class="toolbar-box">
                  ...
                  <input type="hidden" id="subSubjectMatter" name="sub_subject_matter" class="quill">
                </div>
                <div class="invalid-feedback"></div>
              </div>
              <div class="col-12">
