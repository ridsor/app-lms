                    ...
                    @foreach ($schedule->schedule_times as $schedule_time)
                      <div class="d-flex gap-2 c-o-light f-w-600 flex-wrap text-nowrap">
                        <div class="d-flex align-items-center">
                          ...
                          <span class="mb-0 ms-2" id="date">{{ Helper::getDayName($schedule_time->day) }}, </span>
                        </div>
                        <div>
                          <span>
                            <span id="start_time">{{ $schedule_time->start_time->translatedFormat('H:i') }}</span> -
                            <span id="end_time">{{ $schedule_time->end_time->translatedFormat('H:i') }}</span> WIT
                          </span>
                        </div>
                      </div>
                    @endforeach
