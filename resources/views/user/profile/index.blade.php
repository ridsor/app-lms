              ...
              <div class="user-image">
                <div class="avatar">
                  <div class="common-align">
                    <div><img id="output"
                        src="{{ $user->image ? asset('storage/' . $user->image) : asset('assets/svg/user-placeholder.svg') }}"
                        alt="Profile Image"><input type="file" accept="image/*" onchange="loadFile(event)">
                    ...
                    <div class="user-designation"><a target="_blank" href="">{{ $user->name }}</a>
                      <div class="desc">{{ Helper::getRoleLabel($user->getRoleNames()->first()) }}</div>
                    </div>
                  </div>
                </div>
              </div>
                              ...
                              <form class="custom-input" id="change-password"
                                ...
                                <div class="form-group mb-2">
                                  ...
                                  <div class="form-input position-relative">
                                    <input class="form-control password" type="password" name="current_password">
                                    <div class="show-hide-change-password"><span class="show"></span></div>
                                  </div>
