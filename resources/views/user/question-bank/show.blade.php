            ...
            <div class="card-body">
              <div class="row g-3">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                  ...
                  <p class="c-o-light f-w-600">
                    <span>
                      {{ $question_bank->multipleQuestions->count() + $question_bank->essayQuestions->count() }}
                    </span>
                  </p>
                </div>
                <div class="col-12 col-md-6 col-lg-3">
                  ...
                  <p class="c-o-light f-w-600">
                    <span>
                      {{ $question_bank->multipleQuestions()->sum('question_points') + $question_bank->essayQuestions()->sum('question_points') ?? 0 }}
                    </span>
                  </p>
                </div>
              </div>
