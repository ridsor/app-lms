                                                                ...
                                                                <div class="row g-3">
                                                                        ...
                                                                        <div class="row g-3">
                                                                            <div class="col-12">
                                                                                <label class="form-label"
                                                                                    for="editMaterialTitle">Judul<span
                                                                                        class="txt-danger">*</span></label>
                                                                                <input class="form-control"
                                                                                    id="editMaterialTitle" type="text"
                                                                            ...
                                                                            <div class="col-12">
                                                                                <label class="form-label"
                                                                                    for="editExamType">Jenis Ujian<span
                                                                                        class="txt-danger">*</span></label>
                                                                                <select class="form-select" id="editExamType"
                                                                                    name="type">
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="d-flex flex-column flatpicker-form">
                                                                                    <label class="form-label"
                                                                                        for="startDate">Waktu Mulai<span
                                                                                            class="txt-danger">*</span></label>
                                                                                    <input class="form-control flatpicker"
                                                                                        id="editExamStartTime" type="date"
                                                                                        placeholder="Pilih waktu mulai"
                                                                                        name="start_time" data-language="id">
                                                                                    <div class="invalid-feedback"></div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12">
                                                                                <div
                                                                                    class="d-flex flex-column flatpicker-form">
                                                                                    <label class="form-label"
                                                                                        for="endDate">Waktu Selesai<span
                                                                                            class="txt-danger">*</span></label>
                                                                                    <input class="form-control flatpicker"
                                                                                        autocomplete="off"
                                                                            ...
                                                                            <div class="col-12">
                                                                                <label class="form-label"
                                                                                    for="editSchedule">Jadwal<span
                                                                                        class="txt-danger">*</span></label>
                                                                                <select class="selectpicker search-picker"
                                                                                    data-live-search="true" id="editSchedule"
                                                                                    name="schedule_id">
                                                                    ...
                                                                    <div class="col-12 col-md-6">
                                                                        <div class="row g-3">
                                                                            <div class="col-12">
                                                                                <label class="form-label"
                                                                                    for="editExamDescription">Deskripsi<span
                                                                                        class="txt-danger"></span></label>
                                                                                <div class="toolbar-box">
                                                                                    <div id="editExamToolbar">
                                                                                        <button class="ql-bold">Bold</button>
                                                                                        <button
                                                                                            class="ql-italic">Italic</button>
                                                                                        <button
                                                                                            class="ql-underline">underline</button>
                                                                                        <button
                                                                                            class="ql-strike">Strike</button>
                                                                                        <button class="ql-list"
                                                                                            value="ordered">List</button>
                                                                                        <button class="ql-list"
                                                                                            value="bullet"></button>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <label class="form-label"
                                                                                    for="editAllowLateSubmission">Sifat</label>
                                                                                <div class="checkbox-checked d-flex gap-2">
                                                                                    <label
                                                                                        class="d-flex align-items-center mb-0"
                                                                                        style="align-self: flex-start">
                                                                                        <input type="radio"
                                                                                            value="Closed Book" checked
                                                                                            name="exam_mode"
                                                                                            class="me-2 form-check-input radio"
                                                                                            style="transform: translateY(-2px)">
                                                                                        <span
                                                                                            class="fw-bold text-uppercase">Tutup
                                                                                            Buku</span>
                                                                                    </label>
                                                                                    <label
                                                                                        class="d-flex align-items-center mb-0"
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            ...
                                                                                            style="transform: translateY(-2px)">
                                                                                        <span
                                                                                            class="fw-bold text-uppercase">Buka
                                                                                            Terbuka</span>
                                                                                    </label>
                                                                                </div>
                                                                                <div class="invalid-feedback"></div>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <label class="form-label"
                                                                                    for="editAllowLateSubmission">Acak
                                                                                    Soal</label>
                                                                                <div class="checkbox-checked d-flex gap-2">
                                                                                    <label
                                                                                        class="d-flex align-items-center mb-0"
                                                                                        ...
                                                                                        <input type="radio" value="0"
                                                                                            checked name="is_shuffle_questions"
                                                                                            class="me-2 form-check-input radio"
                                                                                            style="transform: translateY(-2px)">
                                                                                        <span
                                                                                            class="fw-bold text-uppercase">Tidak</span>
                                                                                    </label>
                                                                                    <label
                                                                                        class="d-flex align-items-center mb-0"
                                                                                        style="align-self: flex-start">
                                                                                        <input type="radio" value="1"
                                                                                            ...
                                                                                            style="transform: translateY(-2px)">
                                                                                        <span
                                                                                            class="fw-bold text-uppercase">Ya</span>
                                                                                    </label>
                                                                                </div>
                                                                                <div class="invalid-feedback"></div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-12 duration"
                                                                                ...
                                                                                <div class="d-flex flex-column">
                                                                                    <label class="form-label"
                                                                                        for="editDurationExam">Batas
                                                                                        Waktu</label>
                                                                                    <input class="form-control"
                                                                                        autocomplete="off"
                                                                                        id="editDurationExam" type="number"
