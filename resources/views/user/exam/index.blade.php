            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a>Ujian</a></li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body px-2 mb-2 px-md-3 py-4 common-offcanvas">
                            @role('operator')
                                <button class="btn btn-primary f-w-500 mb-2 w-100" type="button" data-bs-toggle="modal"
                                    data-bs-target="#addExamModal"><i class="fa fa-plus pe-2"></i>Tambah Ujian</button>
                            @endrole
                            <div class="row g-3 align-items-center mb-4">
                                ...
                                <div class="col-auto">
                                    <button type="button" data-bs-toggle="offcanvas" data-bs-target="#filter"
                                    ...
                                    <div class="offcanvas offcanvas-end" id="filter" tabindex="-1"
                                        aria-labelledby="filterLabel">
                                        <div class="offcanvas-header pb-0">
                                            <h5 class="offcanvas-title" id="filterLabel">Filter</h5><button
                                        ...
                                        <div class="offcanvas-body custom-input custom-scrollbar">
                                            <div class="row g-3">
                                                ...
                                                @role(['teacher', 'operator'])
                                                    <div class="col-12">
                                                        ...
                                                        <select class="form-select" id="class-filter"
                                                            aria-label="Select class" name="kelas">
                                                ...
                                                @role(['teacher', 'operator'])
                                                    <div class="col-12">
                                                        ...
                                                        <select class="form-select" id="level-filter"
                                                            aria-label="Select level" name="tingkat">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <select class="form-select" id="type-filter" name="tipe"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input class="form-control flatpickr-input start-date"
                                                        id="start-date-filter" type="date" autocomplete="off"
                                                        name="rentang-waktu-dari" placeholder="YYYY-MM-DD H:i">
                                                </div>
                                                <div class="col-12"><label class="form-label">Rentang Waktu Sampai</label>
                                                    <input class="form-control flatpickr-input end-date"
                                                        id="end-date-filter" placeholder="YYYY-MM-DD H:i" type="date"
                                                        name="rentang-waktu-sampai" autocomplete="off">
                                                </div>
                                                <div class="col-12 d-flex justify-content-end align-items-center gap-2">
                                                    ...
                                                    <button class="btn btn-primary f-w-500"
                                                        id="filter-btn">Terapkan</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="task-item border rounded-1 w-100 p-3">
                                            <div class="row g-2">
                                                <div class="col-12 col-md">
                                                    ...
                                                    <p class="mb-1">{{ $exam->schedule->subject->code }}
                                                        {{ strtoupper($exam->schedule->subject->name) }} &middot;
                                                        {{ $exam->schedule->class->name }}{{ $exam->schedule->class->level }}{{ $exam->schedule->class->major ? ' ' . $exam->schedule->class->major->name : '' }}
                                                        &middot; {{ Helper::getExamTypeLabel($exam->type) }}</p>
                                                        ...
                                                        <div class="row g-0 g-sm-2">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <span
                                                                        class="mb-0 ms-2">{{ $exam->start_time->translatedFormat('d M Y') }}</span>
                                                                </div>
                                                                <div>&middot;</div>
                                                                <span>
                                                                    {{ $exam->start_time->translatedFormat('H:i') }} WIT
                                                                </span>
                                                            </div>
                                                            <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <span class="icon"><i data-feather="calendar"
                                                                            style="width:18px; height: 18px"></i></span>
                                                                    <span
                                                                        class="mb-0 ms-2">{{ $exam->end_time->translatedFormat('d M Y') }}</span>
                                                                </div>
                                                                <div>&middot;</div>
                                                                <span>
                                                                    {{ $exam->end_time->translatedFormat('H:i') }} WIT
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div
                                                    class="col-12 justify-content-end flex-wrap col-md-auto d-flex align-items-center gap-2">
                                                    @role(['student', 'parent'])
                                                        @if ($exam?->results->where('exam_id', $exam->id)->isEmpty())
                                                            <span
                                                                class="badge m-0 badge-light-danger px-2 py-1 d-flex align-items-center">
                                                                Belum dikerjakan
                                                            </span>
                                                        @endif
                                                    @endrole
                                                    @role('operator')
                                                        <button
                                                            ...
                                                            onclick="handleEditExam(event, {{ $exam->id }})">
                                ...
                                @else
                                    ...
                                    <div class="d-flex justify-content-center mb-3 w-100">
                                        <div class="px-4 py-5 d-grid" style="justify-items: center">
                                            ...
                                            <p class="mb-0 text-center">Belum ada ujian yang tersedia.</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
                            @include('user.exam.modal')
                        </div>
                    </form>
                </div>
            </div>
