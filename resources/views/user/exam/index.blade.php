                    ...
                    <div class="offcanvas-body custom-input custom-scrollbar">
                      <div class="row g-3">
                        ...
                        <div class="col-12">
                          ...
                          <select class="selectpicker search-picker filter" name="mata-pelajaran" data-live-search="true"
                            id="subject-filter">
                        ...
                        @role(['teacher', 'operator'])
                          <div class="col-12">
                            ...
                            <select class="form-select" id="class-filter" aria-label="Select class" name="kelas">
                        ...
                        @role(['teacher', 'operator'])
                          <div class="col-12">
                            ...
                            <select class="form-select" id="level-filter" aria-label="Select level" name="tingkat">
                            ...
                            <div class="row g-0 g-sm-2">
                              <div class="col-12 col-md-auto d-flex align-items-center gap-2 justify-content-center">
                                <div class="d-flex align-items-center">
                                  ...
                                  <span class="mb-0 ms-2">{{ $exam->start_time->translatedFormat('d M Y') }}</span>
                                </div>
                                <div>&middot;</div>
                                <span>
                              ...
                              <div class="col-12 col-md-auto d-flex align-items-center gap-2 justify-content-center">
                                <div class="d-flex align-items-center">
                                  <span class="icon"><i data-feather="calendar"
                                      style="width:18px; height: 18px"></i></span>
                                  <span class="mb-0 ms-2">{{ $exam->end_time->translatedFormat('d M Y') }}</span>
                                </div>
                                <div>&middot;</div>
                                <span>
                        ...
                        <div class="col-12 justify-content-end flex-wrap col-md-auto d-flex align-items-center gap-2">
                          @role('teacher')
                            @if ($exam?->not_yet_rated)
                              <span class="badge m-0 badge-light-danger px-2 py-1 d-flex align-items-center">Belum
                                dinilai <span class="badge ms-1 badge-danger">{{ $exam->not_yet_rated }}</span></span>
                            @endif
                          @endrole
                          @role(['student', 'parent'])
                          ...
                          @role('operator')
                            ...
                            <button
                              ...
                              style="width: 38px; height: 38px;" onclick="handleDeleteExam(event, {{ $exam->id }})">
