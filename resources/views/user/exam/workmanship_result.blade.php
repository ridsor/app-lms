      ...
      <div class="card-body p-3">
        ...
        <div class="wrapper-result p-3 mb-3">
          <div class="text-center mb-3">
            <p class="mb-0 fs-5">Anda memperoleh <span class="fw-medium txt-primary">{{ $examResult->formatted_score }}
                poin</span></p>
          </div>
          @php
          ...
          @if ($hasPendingScores)
            <div class="d-flex align-items-center justify-content-center" style="height: 100%;">
              <div id="progress-text" class="fs-6 text-center">Nilai ini hanya <span
                  class="text-warning">sementara</span>, menunggu penilaian guru...
              </div>
            </div>
          @endif
        </div>
