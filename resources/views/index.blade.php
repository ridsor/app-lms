          ...
          <div class="col-sm-12 wow pulse">
            <div class="landing-title">
              <div class="d-flex d-flex gap-2 flex-column align-items-center mb-2">
                <img class="img-fluid for-light" src="{{ asset('assets/images/logo_sekolah.png') }}" style="width: 50px"
                  alt=""><img class="img-fluid for-dark" src="{{ asset('assets/images/logo_sekolah.png') }}"
            ...
            <div class="vector-image"> <img src="{{ asset('assets/images/home-women.svg') }}" alt="vector women">
            </div>
          </div>
        </div>
