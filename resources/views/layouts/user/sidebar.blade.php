            ...
            <div class="sidebar-wrapper" data-sidebar-layout="stroke-svg">
              <div>
                  ...
                  <a href="{{ route('user.home') }}">
                    <div class="d-flex d-flex gap-2 flex-column align-items-start">
                      <img class="img-fluid for-light" src="{{ asset('assets/images/logo_sekolah.png') }}"
                        style="width: 35px" alt=""><img class="img-fluid for-dark"
                        src="{{ asset('assets/images/logo_sekolah.png') }}" style="width: 35px" alt="">
                    </div>
                  </a>
                ...
                <div class="logo-icon-wrapper"><a href="{{ route('user.home') }}"><img class="img-fluid"
                      src="{{ asset('assets/images/logo_sekolah.png') }}" style="width: 35px" alt=""></a></div>
                <nav class="sidebar-main">
                  <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
                  <div id="sidebar-menu">
                    <ul class="sidebar-links" id="simple-bar">
                      <li class="back-btn"><a href="{{ route('user.home') }}"><img class="img-fluid"
                            src="{{ asset('assets/images/logo_sekolah.png') }}" style="width: 35px" alt=""></a>
                        <div class="mobile-back text-end"><span>Kembali</span><i class="fa-solid fa-angle-right ps-2"
                      ...
                      @can('student.*')
                        <li class="sidebar-list">
                          <i class="fa-solid fa-thumbtack"></i>
                          <a class="sidebar-link sidebar-title link-nav" href="{{ route('user.period.index') }}"><svg
                              class="stroke-icon">
                        ...
                        <li class="sidebar-list">
                          <i class="fa-solid fa-thumbtack"></i>
                          <a class="sidebar-link sidebar-title link-nav" href="{{ route('user.major.index') }}"><svg
                              class="stroke-icon">
                              <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-user') }}"></use>
                            </svg><svg class="fill-icon">
                              <use href="{{ asset('assets/svg/icon-sprite.svg#fill-user') }}"></use>
                        ...
                        <li class="sidebar-list">
                          <i class="fa-solid fa-thumbtack"></i>
                          <a class="sidebar-link sidebar-title link-nav"
                            href="{{ route('user.journal.classlist') }}"><svg class="stroke-icon">
                              <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-calendar') }}">
                              </use>
                            </svg><svg class="fill-icon">
                              <use href="{{ asset('assets/svg/icon-sprite.svg#fill-calendar') }}"></use>
                            </svg><span class="lan-3">Jurnal Mengajar </span></a>
                        </li>
                      @endcan
                      @can('schedule.view')
                      ...
                      @can('task.view')
                        <li class="sidebar-list">
                          <i class="fa-solid fa-thumbtack"></i>
                          <a class="sidebar-link sidebar-title link-nav" href="{{ route('user.task.index') }}"><svg
                              class="stroke-icon">
                              <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-calendar') }}">
                              </use>
                            </svg><svg class="fill-icon">
