    ...
    <div class="row m-0">
      <div class="col-12 p-0">
        <div class="login-card login-dark">
          <div>
            <div>
              <a class="logo" href="index.html"><img class="img-fluid for-light" src="/assets/images/logo/logo.png"
                  alt="looginpage" /><img class="img-fluid for-dark" src="/assets/images/logo/logo_dark.png"
                  alt="looginpage" /></a>
            </div>
            <div class="login-main">
              <form class="theme-form" action="{{ route(Helper::getRouteByRole($role) . '.login') }}" method="POST">
                @csrf
                <h4>
                ...
                <div class="form-group mb-0">
                  <div class="form-check">
                    <input class="checkbox-primary form-check-input" id="checkbox1" type="checkbox"
                      name="remember" /><label class="text-muted form-check-label" for="checkbox1">Ingat saya</label>
                  </div>
                  <div class="text-end">
                    <button
