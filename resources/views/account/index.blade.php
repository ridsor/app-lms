                ...
                <div class="avatar">
                  <div class="common-align">
                    <div class="bg-light"><img id="output"
                        ...
                        alt="Profile Image"><input type="file" accept="image/png, image/jpg, image/jpeg"
                ...
                <div class="row g-3">
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="ttl-info text-start pb-0">
                      ...
                      @if (!$user->teacher->birthplace && !$user->teacher->date_of_birth)
                        <span>-</span>
                      @else
              ...
              <div class="card-body">
                <div class="row g-3">
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="ttl-info text-start pb-0">
                      <h6>Tempat & Tanggal Lahir</h6>
                      @if (!$user->student->birthplace && !$user->student->date_of_birth)
                        <span>-</span>
                      @else
